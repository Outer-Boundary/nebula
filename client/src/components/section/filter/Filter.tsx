import { collection, doc, getDoc, getDocs, orderBy, query, QueryConstraint, where } from "firebase/firestore";
import { useEffect, useState } from "react";
import { FiSearch } from "react-icons/fi";
import { TiArrowSortedDown, TiArrowSortedUp } from "react-icons/ti";
import { database } from "shared/firestore";
import { Categories, CategoryType } from "shared/types";
...
export default function Filter(props: FilterProps) {
  ...
  async function filterProducts() {
    ...
    const productsQuery = query(collection(database, "products"), where("title", ">=", "plain"), where("title", "<=", "plain" + "z"));
    const productsSnapshop = await getDocs(productsQuery);
    console.log(productsSnapshop.docs);
  ...
  // function searchFilter(filters: QueryConstraint[]) {
  ...
  //   let curFilters: QueryConstraint[] = [];
  //   for (const searchFilter of searchFilters) {
  //     let isNegated = searchFilter.startsWith("-");
  //     curFilters.push(where("title", ">=", `title:*${isNegated ? searchFilter.replace("-", "") : searchFilter}*`));
  //   }
  ...
  // function sizeFilter(filters: QueryConstraint[]) {
  ...
  // function materialFilter(filters: QueryConstraint[]) {
  ...
  // function priceRangeFilter(filters: QueryConstraint[]) {
